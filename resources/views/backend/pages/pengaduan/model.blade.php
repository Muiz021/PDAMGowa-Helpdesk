                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_pengaduan" id="SelectLm" class="form-control-sm form-control">
                                ...
                                <option value="1"
                                    ...
                                    Mengalir</option>
                                <option value="2" {{ $item->jenis_pengaduan == 'air_keruh' ? 'selected' : '' }}>Air
                                    Keruh</option>
                                <option value="3"
                                    {{ $item->jenis_pengaduan == 'keberatan_bayar' ? 'selected' : '' }}>Keberatan Bayar
                                </option>
                                <option value="4"
                                    {{ $item->jenis_pengaduan == 'pembenahan_sambungan' ? 'selected' : '' }}>Pembenahan
                                    Sambungan</option>
                            </select>
                        </div>
                        <div class="form-group">
